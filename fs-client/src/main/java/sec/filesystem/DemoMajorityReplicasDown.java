...
/*  Demo Class used for demonstrating what happens to the client if there
    are more than N/2-1 faulty replicas. In this case, only N/2 replicas are online
...
public class DemoMajorityReplicasDown {
    ...
    public static void main(String[] args) {
        ...
        int simulatedReplicas = 2 * REPLICAS;
